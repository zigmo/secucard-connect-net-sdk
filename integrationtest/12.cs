...
namespace Secucard.Connect.IntegrationTest
{
    ...
    public class IntegrationTest12
    {
        ...
        public void Test()
        {
            ...
            var basketinfo = new BasketInfo {Currency = "EUR", Sum = 151};
            var basket = new Basket();
            basket.Products.Add(new Product.Smart.Model.Product
            {
                ArticleNumber = "1234",
                Desc = "Description",
                Ean = "12345678",
            ...
            var transaction = new Secucard.Connect.Product.Smart.Model.Transaction
            {
                Basket = basket,
                BasketInfo = basketinfo
            };
            transaction = client.Smart.Transactions.Create(transaction);

...
using Zigmo.Secucard.Connect.NetCore.Net.Stomp;
using Zigmo.Secucard.Connect.NetCore.Product.Document;
using Zigmo.Secucard.Connect.NetCore.Product.General;
using Zigmo.Secucard.Connect.NetCore.Product.Loyalty;
using Zigmo.Secucard.Connect.NetCore.Product.Payment;
using Zigmo.Secucard.Connect.NetCore.Product.Service;
using Zigmo.Secucard.Connect.NetCore.Product.Smart;
using Zigmo.Secucard.Connect.NetCore.Storage;
using Zigmo.Secucard.Connect.NetCore.Trace;

namespace Zigmo.Secucard.Connect.NetCore
{
    using SmartTransactionsService = TransactionsService;
